    ...
    <head>
        ...
        <style>
            @font-face {
                ...
                font-weight: normal;
                font-style: normal;
                src: url("../templates/admin/assets/fonts/Roya-Regular.eot");
                src: url("../templates/admin/assets/fonts/Roya-Regular.eot?#iefix") format("embedded-opentype"), url("../templates/admin/assets/fonts/Roya-Regular.woff") format("woff"), url("../templates/admin/assets/fonts/Roya-Regular.ttf") format("truetype"), url("../templates/admin/assets/fonts/Roya-Regular.svg#Roya") format("svg")
            }
            ...
            @font-face {
                ...
                font-weight: bold;
                font-style: normal;
                src: url("../templates/admin/assets/fonts/Roya-Bold.eot");
                src: url("../templates/admin/assets/fonts/Roya-Bold.eot?#iefix") format("embedded-opentype"), url("../templates/admin/assets/fonts/Roya-Bold.woff") format("woff"), url("../templates/admin/assets/fonts/Roya-Bold.ttf") format("truetype"), url("../templates/admin/assets/fonts/Roya-Regular.svg#Roya") format("svg")
            }
    ...
    <body>
        <center>
            <div class="a">
                ...
                <img src="<?php echo RELA_DIR . 'templates/' . CURRENT_SKIN . '/images/logo@2x.png' ?> " align="right" style="position:absolute; right:40px;padding-top:15px; " height="60">
                <div style="clear:both"></div>
                <a href="<?= $page ?>">ورود به سامانه ارزيابی برنامه عملياتی</a>
                <br>
                <small>درحال بارگذاری ...</small>
                <div style="clear:both"></div>
            </div>
        </center>
    </body>
...
function myLog($text)
{
    include_once ROOT_DIR . 'component/log/model/log.model.php';
    $objjj = new log();
    $objjj->log = $text;
    $objjj->save();
    return true;
...
function fileUploader($input = array(), $file = array())
{
    ...
    if (isset($input['type'])) {
        ...
        $type = array('jpg', 'xls', 'xlsx', 'mp4', 'png', 'jpeg', 'pdf', 'doc', 'docx', 'pps', 'ppt', 'pptx', 'zip', 'rar');
    }
    ...
    if (isset($input['max_size'])) {
        ...
        $maxSize = '110485760';  //max size is 10 MB
    }
    ...
    if (isset($input['new_name'])) {
        $target_file = $target_dir  . basename($input['new_name']) . '.' . $fileType;
        $result['image_name'] =  basename($input['new_name']) . '.' . $fileType;
    } else {
...
function translate($text, $lang = '')
{
    ...
    include_once ROOT_DIR . 'component/dictionary/model/dictionary.model.php';

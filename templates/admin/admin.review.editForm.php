...
<div class="content-control">
  ...
  <ul class="control-nav pull-right">
      <li><a class="rtl text-24"><i class="fa fa-file-image-o"></i> ویرایش اطلاعات تماس</a></li>
  </ul><!--/control-nav-->
</div><!-- /content-control -->
...
<div class="content-body">
  ...
  <div id="panel-tablesorter" class="panel panel-warning">
    <div class="panel-heading bg-white">
      <h3 class="panel-title rtl">جزییات اطلاعات تماس</h3>
            ...
            <div class="row">
              <div class="col-xs-12 col-sm-12 col-md-6">
                <div class="form-group">
                  <label class="col-xs-12 col-sm-4 pull-right control-label rtl" for="title">تلفن:</label>
              ...
              <div class="col-xs-12 col-sm-12 col-md-6">
                <div class="form-group">
                  <label class="col-xs-12 col-sm-4 pull-right control-label rtl" for="brief_description ">ایمیل:</label>
                  <div class="col-xs-12 col-sm-8 pull-right">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        <label class="col-xs-12 col-sm-4 pull-right control-label rtl" for="description ">آدرس</label>
                        <div class="col-xs-12 col-sm-8 pull-right">
                            <?php
              ...
              <div class="col-md-12">
                <p class="pull-left">
                  <button type="submit" name="update" id="submit" class="btn btn-icon btn-success rtl">
                    ...
                    <input name="Review_id" type="hidden" id="" value="<?=$list['Review_id']?>" />

...
<div class="content-control">
  ...
  <ul class="control-nav pull-right">
      <li><a class="rtl text-24"><i class="fa fa-file-image-o"></i> ویرایش اطلاعات کاربران</a></li>
  </ul><!--/control-nav-->
</div><!-- /content-control -->
...
<div class="content-body">
  ...
  <div id="panel-tablesorter" class="panel panel-warning">
    <div class="panel-heading bg-white">
      <h3 class="panel-title rtl">جزییات اطلاعات کاربران</h3>
            ...
            <div class="row">
              <div class="col-xs-12 col-sm-12 col-md-6">
                ...
                <div class="form-group">
                  <label class=" pull-right control-label rtl" for="password ">گذرواژه:</label>
                  <div class="pull-right">
                    <input type="text" class="form-control" name="password" id="password"   value="<?=$list['password']?>">
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-12">
                <p class="pull-left">
                  <button type="submit" name="update" id="submit" class="btn btn-icon btn-success rtl">
                    ...
                    <input name="admin_id" type="hidden" id="" value="<?=$list['admin_id']?>" />
